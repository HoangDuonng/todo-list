...
> If you're very new to Clean Architecture, I recommend you check [more simple demo](https://github.com/HoangDuonng/simple-clean-architecture-demo).
...
```shell
git clone https://github.com/HoangDuonng/microservices-clean-architecture-demo
